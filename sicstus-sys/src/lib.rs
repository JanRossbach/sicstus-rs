...
pub mod ffi {
    use super::{
        spio_t_bits, spio_t_error_code, spio_t_offset, spio_t_simple_device_close,
        spio_t_simple_device_flush_output, spio_t_simple_device_interrupt,
    ...
    extern "C" {
        ...
        pub fn SP_event(func: extern "C" fn(arg1: *mut c_void) -> c_int, arg: *mut c_void)
            -> c_int;
